...
require_once 'funciones/datosindex.php';
$MiConexion=ConexionBD();

$contado = Contar($MiConexion);
?>
<!DOCTYPE html>
<html lang="en">  
  <head>
      ...
      <div class="row">
        <div class="col-md-3">
          <div class="widget-small primary coloured-icon"><i class="icon fa fa-users fa-3x"></i>
            <div class="info">
              <h4>Usuarios</h4>
              <p><b><?php echo $contado['TOTAL_USU'] ?></b></p>
            </div>
          </div>
        </div>
        <div class="col-md-3">
          <div class="widget-small info coloured-icon"><i class="icon fa fa-thumbs-o-up fa-3x"></i>
            <div class="info">
              ...
              <p><b><?php echo $contado['SOLI_1']?></b></p>
            </div>
          </div>
        </div>
        <div class="col-md-3">
          <div class="widget-small warning coloured-icon"><i class="icon fa fa-files-o fa-3x"></i>
            <div class="info">
              ...
              <p><b><?php echo $contado['SOLI_3']?></b></p>
            </div>
          </div>
        </div>
        <div class="col-md-3">
          <div class="widget-small danger coloured-icon"><i class="icon fa fa-star fa-3x"></i>
            <div class="info">
              ...
              <p><b><?php echo $contado['SOLI_2']?></b></p>
            </div>
          </div>
        </div>
      </div>
